...
# - g(x_i | x_j): Similarità (Predictive likelihood per X) [cite: 681]
...
# 4. MODELLO AUSILIARIO PER X (Similarità) [cite: 687]
...
# g(x_j*) = \prod_{l=1}^P g_l(x_jl*) [cite: 1036]
...
PPMx_kernel_gaussiano <- function(y, x, 
  ...
  for(g in 1:n_iter) {
    ...
    # I parametri per X sono ausiliari e non ci servono. [cite: 742]
